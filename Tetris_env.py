...
class Tetrino:
    ...
    TETRINOS = {  
        1: [np.array([[1, 1], [1, 1]]), [0, 255, 255], 1],  
        2: [np.array([[2, 2, 2, 2]]), [255, 255, 0], 2],  
        3: [np.array([[3, 3, 0], [0, 3, 3]]), [0, 0, 255], 2],  
        4: [np.array([[0, 4, 4], [4, 4, 0]]), [0, 255, 0], 2],  
        5: [np.array([[0, 0, 5], [5, 5, 5]]), [0, 127, 255], 4],  
        6: [np.array([[6, 0, 0], [6, 6, 6]]), [255, 0, 0], 4],  
        7: [np.array([[0, 7, 0], [7, 7, 7]]), [255, 0, 255], 4]  
    }

    # Define the size of the shape outline
    OUTLINE_SIZE = 1
...
# class Tetrino:
#     # Each Tetrimino's coordinates within the smallest mxm array possible (2x2, 3x3, or 4x4)
#     TETRINOS = {
#         1: {
...
#     def __init__(self, id):
#         self.rotation = 0  # 0 - 3
#         self.ref_point = np.array([0, 3])  # Coordinates of the piece's top left corner
#         self.id = id  # 0-6 integer which represents the piece's shape in TETRINOS
...
#     def reset(self):
#         # Reset the piece to its default position
#         self.rotation = 0
#         self.ref_point = np.array([0, 3])

#     def move(self, direction):
#         # Move the piece by shifting its reference point
...
#         self.dim = [self.shape.shape[0], self.shape.shape[1]]
#         self.rotation = (self.rotation + 1) % self.num_unique
...
class Tetris:
    ...
    def show(self):
        empty_tile_color = (80,80,80)  # BGR background color (220,220,220)
        spawn_zone_color = (21,13,38) #colors
        ...
        title_color = (34,255,255) #Name Colors
